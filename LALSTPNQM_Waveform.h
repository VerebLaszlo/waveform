 ...
 */
int LALSTPNQM_Derivator(REAL8 t, const REAL8 values[], REAL8 dvalues[], void * params);
 ...
 */
void
LALSTPNQM_Generator(LALStatus *status, LALSTPNQM_Waveform_Params *params, CoherentGW *waveform);
